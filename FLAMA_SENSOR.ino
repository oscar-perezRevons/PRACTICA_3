...
const int analogPin = 34;  // Pin A0 del sensor conectado al pin GPIO34 del ESP32
const int digitalPin = 35;
...
const char * PUBLISH_TOPIC = "publish";               // TOPIC where ESP32 publishes
const char * SUBSCRIBE_TOPIC = "subscribe";           // TOPIC where ESP32 receive
...
void loop() {
  ...
  // Leemos la salida digital del sensor
